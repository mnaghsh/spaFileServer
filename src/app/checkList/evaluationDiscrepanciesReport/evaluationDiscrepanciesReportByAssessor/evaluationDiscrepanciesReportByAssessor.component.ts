...
@Component({
  ...
  templateUrl: './evaluationDiscrepanciesReportByAssessor.component.html',
  styleUrls: ['./evaluationDiscrepanciesReportByAssessor.component.css']
})
export class EvaluationDiscrepanciesReportByAssessorComponent implements OnInit {
  ...
  getAllSchedules() {
    ...
    if (this.selectedPeriod != 4) {
      ...
      this.evaluationDiscrepancies.filterEvaluationDiscrepanciesReportsByAssessor(body).subscribe(
